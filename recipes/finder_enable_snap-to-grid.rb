execute "Enable snap-to-grid for icons on the desktop" do
...
execute "Enable snap-to-grid in other icon views 1/2" do
...
execute "Enable snap-to-grid in other icon views 2/2" do
